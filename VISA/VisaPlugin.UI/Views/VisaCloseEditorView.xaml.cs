...
public partial class VisaCloseEditorView : UserControl, IRefreshableEditor
{
	...
	public static readonly DependencyProperty SequenceFileProperty =
	    DependencyProperty.Register(nameof(SequenceFile), typeof(SequenceFile), typeof(VisaCloseEditorView),
	...
	public static readonly DependencyProperty EditPositionProperty =
	    DependencyProperty.Register(nameof(EditPosition), typeof(EditPosition), typeof(VisaCloseEditorView),
	        new PropertyMetadata(null));
