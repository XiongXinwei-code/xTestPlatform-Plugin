...
public class LxiQueryViewModel : LxiViewModelBase
{
	private LxiQuerySetting? _setting;
	...
	protected override void Load()
	{
		...
		try
		{
			_setting = _step.StepSetting.Setting is { Length: > 0 } d
				? (LxiQuerySetting)_serializer.Deserialize(d, _step.StepSetting.SettingVersion)
				: (LxiQuerySetting)_serializer.CreateDefault();
