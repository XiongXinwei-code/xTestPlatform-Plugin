...
public partial class NiDaqSyncConfigEditorView : UserControl, IRefreshableEditor
{
    ...
    public static readonly DependencyProperty SequenceFileProperty =
        DependencyProperty.Register(nameof(SequenceFile), typeof(SequenceFile), typeof(NiDaqSyncConfigEditorView),
    ...
    public static readonly DependencyProperty EditPositionProperty =
        DependencyProperty.Register(nameof(EditPosition), typeof(EditPosition), typeof(NiDaqSyncConfigEditorView),
            new PropertyMetadata(null));
