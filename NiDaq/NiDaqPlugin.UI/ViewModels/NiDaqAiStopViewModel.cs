...
public class NiDaqAiStopViewModel : INotifyPropertyChanged
{
    ...
    private NiDaqAiStopSetting? _setting;
    ...
    private void Load()
    {
        ...
        try
        {
            _setting = _step.StepSetting.Setting is { Length: > 0 } d
                ? (NiDaqAiStopSetting)_serializer.Deserialize(d, _step.StepSetting.SettingVersion)
                : (NiDaqAiStopSetting)_serializer.CreateDefault();
