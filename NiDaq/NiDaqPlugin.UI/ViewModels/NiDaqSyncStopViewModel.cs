...
public class NiDaqSyncStopViewModel : INotifyPropertyChanged
{
    ...
    private NiDaqSyncStopSetting? _setting;
    ...
    private void Load()
    {
        ...
        try
        {
            _setting = _step.StepSetting.Setting is { Length: > 0 } d
                ? (NiDaqSyncStopSetting)_serializer.Deserialize(d, _step.StepSetting.SettingVersion)
                : (NiDaqSyncStopSetting)_serializer.CreateDefault();
