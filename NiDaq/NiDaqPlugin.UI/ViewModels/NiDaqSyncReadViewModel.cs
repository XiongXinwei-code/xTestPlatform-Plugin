...
public class NiDaqSyncReadViewModel : INotifyPropertyChanged
{
    ...
    public string CustomEventName { get => _setting?.CustomEventName ?? "SyncDataReady"; set { if (_setting == null || _setting.CustomEventName == value) return; _setting.CustomEventName = value; OnPropertyChanged(); QueueSave(); } }
