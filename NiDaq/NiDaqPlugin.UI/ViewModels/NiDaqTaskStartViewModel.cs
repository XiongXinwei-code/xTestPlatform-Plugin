...
public class NiDaqTaskStartViewModel : INotifyPropertyChanged
{
    ...
    private NiDaqTaskStartSetting? _setting;
    ...
    private void Load()
    {
        ...
        try
        {
            _setting = _step.StepSetting.Setting is { Length: > 0 } d
                ? (NiDaqTaskStartSetting)_serializer.Deserialize(d, _step.StepSetting.SettingVersion)
                : (NiDaqTaskStartSetting)_serializer.CreateDefault();
