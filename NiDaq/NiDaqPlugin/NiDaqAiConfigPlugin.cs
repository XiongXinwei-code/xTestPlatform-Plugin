...
public sealed class NiDaqAiConfigPlugin : StepPluginBase<NiDaqAiConfigSetting>, IStepPlugin
{
		...
		CancellationToken cancellationToken = default)
	{
        ...
        var s = (NiDaqAiConfigSetting)CreateSerializer().Deserialize(context.Setting, context.CurrentStep.StepSetting.SettingVersion);
