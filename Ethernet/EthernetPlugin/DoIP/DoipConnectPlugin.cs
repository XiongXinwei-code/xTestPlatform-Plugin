...
public sealed class DoipConnectPlugin : StepPluginBase<DoipConnectSetting>
{
    ...
    public override string Description => """
        ...
        | 参数 | 类型 | 必填 | 默认值 | 说明 |
        |------|------|------|--------|------|
        | SessionName | string([ExpressionField] -> string) | 是 | "DOIP1" | 会话标识名 |
        | RemoteHost | string([ExpressionField] -> string) | 是 | "192.168.1.10" | DoIP 实体 IP |
        | RemotePort | string([ExpressionField] -> string) | 是 | "13400" | TCP 端口 |
