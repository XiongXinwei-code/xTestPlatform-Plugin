...
public class OpcUaDisconnectViewModel : INotifyPropertyChanged
{
    ...
    private OpcUaDisconnectSetting? _setting;
    ...
    private void Load()
    {
        ...
        try
        {
            _setting = _step.StepSetting.Setting is { Length: > 0 } d
                ? (OpcUaDisconnectSetting)_serializer.Deserialize(d, _step.StepSetting.SettingVersion)
                : (OpcUaDisconnectSetting)_serializer.CreateDefault();
