...
public partial class ModbusReadEditorView : UserControl, IRefreshableEditor
{
	...
	public static readonly DependencyProperty SequenceFileProperty =
	    DependencyProperty.Register(nameof(SequenceFile), typeof(SequenceFile), typeof(ModbusReadEditorView),
	...
	public static readonly DependencyProperty EditPositionProperty =
	    DependencyProperty.Register(nameof(EditPosition), typeof(EditPosition), typeof(ModbusReadEditorView),
	        new PropertyMetadata(null));
