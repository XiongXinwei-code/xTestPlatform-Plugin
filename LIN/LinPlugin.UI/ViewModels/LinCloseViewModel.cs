...
public class LinCloseViewModel : INotifyPropertyChanged
{
    ...
    private LinCloseSetting? _setting;
    ...
    private void Load()
    {
        ...
        try
        {
            _setting = _step.StepSetting.Setting is { Length: > 0 } d
                ? (LinCloseSetting)_serializer.Deserialize(d, _step.StepSetting.SettingVersion)
                : (LinCloseSetting)_serializer.CreateDefault();
