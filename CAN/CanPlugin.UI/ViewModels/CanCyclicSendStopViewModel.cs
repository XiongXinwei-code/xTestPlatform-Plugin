...
public class CanCyclicSendStopViewModel : INotifyPropertyChanged
{
    ...
    private CanCyclicSendStopSetting? _setting;
    ...
    private void Load()
    {
        ...
        try
        {
            _setting = _step.StepSetting.Setting is { Length: > 0 } d
                ? (CanCyclicSendStopSetting)_serializer.Deserialize(d, _step.StepSetting.SettingVersion)
                : (CanCyclicSendStopSetting)_serializer.CreateDefault();
