...
/// </summary>
public sealed class HttpSoapRequestPlugin : StepPluginBase<HttpSoapRequestSetting>, IStepPlugin
{
		...
		CancellationToken cancellationToken = default)
	{
        ...
        var s = (HttpSoapRequestSetting)CreateSerializer().Deserialize(context.Setting, context.CurrentStep.StepSetting.SettingVersion);
