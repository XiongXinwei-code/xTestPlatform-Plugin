...
/// </summary>
public sealed class HttpClientCreatePlugin : StepPluginBase<HttpClientCreateSetting>, IStepPlugin
{
		...
		CancellationToken cancellationToken = default)
	{
        ...
        var s = (HttpClientCreateSetting)CreateSerializer().Deserialize(context.Setting, context.CurrentStep.StepSetting.SettingVersion);
